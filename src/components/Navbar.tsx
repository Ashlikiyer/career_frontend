                ...
                <DropdownMenuContent className="w-56 bg-white border border-gray-200 shadow-lg" align="end">
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent className="bg-white border border-gray-200">
                      <AlertDialogHeader>
                        <AlertDialogTitle className="text-gray-900">Sign out of your account?</AlertDialogTitle>
                        <AlertDialogDescription className="text-gray-600">
                          You will be redirected to the login page and will need to sign in again to access your saved careers and progress.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
