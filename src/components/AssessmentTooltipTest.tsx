...
const AssessmentTooltipTest = () => {
  ...
  const mockQuestionData = {
    ...
    options_answer:
      "Solving computing problems,Creating visual designs,Analyzing data patterns,Ensuring software quality",
    options_descriptions: {
      "Solving computing problems":
        "Writing code, developing algorithms, and building software solutions to solve technical challenges",
      "Creating visual designs":
        "Designing user interfaces, graphics, and visual elements to create appealing and functional experiences",
      "Analyzing data patterns":
        "Working with datasets, statistics, and analytics to discover insights and trends from information",
      "Ensuring software quality":
        "Testing applications, finding bugs, and making sure software works reliably and meets requirements",
  ...
  console.log(
    ...
    !!mockQuestionData.options_descriptions
  );
  console.log(
    "Description count:",
    Object.keys(mockQuestionData.options_descriptions).length
  );
